...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.last, self.best = self.wdir / "best.pt", self.wdir / "last.pt"  # checkpoint paths
    ...
    def save_model(self):
        ...
        # Save checkpoints
        # self.last.write_bytes(serialized_ckpt)  # save best.pt
        torch.save(ckpt, self.last, pickle_module=pickle)
        if self.best_fitness == self.fitness:
            # self.best.write_bytes(serialized_ckpt)  # save last.pt
        ...
        for f in self.last, self.best:
            if f.exists():
                if f is self.last:
                    ...
                    k = "train_results"  # update last.pt train_metrics from best.pt
        ...
        if resume:
            try:
                ...
                raise FileNotFoundError(
                    ...
                    "i.e. 'yolo train resume model=path/to/best.pt'"
                ) from e
        self.resume = resume
