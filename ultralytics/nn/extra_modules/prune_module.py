...
from .block import Faster_Block, MBConv, RepNCSP, Star_Block, C3k_Faster_CGLU, Faster_Block_CGLU, \
    C3k_MutilScaleEdgeInformationEnhance, MutilScaleEdgeInformationEnhance, C3k_Faster_EMA, Faster_Block_EMA
...
class C3k2_Faster_EMA_v2(nn.Module):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__()
        self.c = int(c2 * e)  # hidden channels
        self.cv0 = Conv(c1, self.c, 1, 1)
