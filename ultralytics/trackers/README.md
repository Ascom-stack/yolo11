...
model = YOLO("path/to/last.pt")  # Load a custom trained model
...
yolo track model=path/to/last.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/last.pt tracker="bytetrack.yaml"
```
