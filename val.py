...
if __name__ == '__main__':
    model = YOLO(r'D:\BaiduNetdiskDownload\ultralytics-yolo11-20241124\ultralytics-yolo11-main\runs\train\v11a4\weights\best.pt') # 选择训练好的权重路径
    model.val(data=r'D:\BaiduNetdiskDownload\ultralytics-yolo11-20241124\ultralytics-yolo11-main\dataset\you.yaml',
